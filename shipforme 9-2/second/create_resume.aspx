<%@ Page Language="C#" AutoEventWireup="true" CodeFile="create_resume.aspx.cs" Inherits="second_create_resume" %>
				...
				<div class="container">
					<div class="contact-grids">
						<div class="contact-left">
							...
							<span>制作属于我们自己的简历，让其他参赛组员能够看到你！</span>
						...
						<div class="contact-right" >
							<form runat="server">
                                ...
                                <div style="width:80%;padding-top:27%">
                                 ...
                                 <div>
                                     <span>参赛意向</span>
                      <asp:DropDownList ID="ddl_competition_name" runat="server" DataSourceID="SqlDataSource1" DataTextField="competition_name" DataValueField="competition_name" Height="30px" Width="50%">
                      </asp:DropDownList>
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=.;Initial Catalog=sfm;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [competition_name] FROM [competition_name]"></asp:SqlDataSource>
								...
								<div>
									<span>技能条件<i style="font-weight:400"></i></span>
                                    <textarea style="min-height:140px" id="tb_personal_skill" runat="server" placeholder="表明对于想要参加的比赛，您已经具备了哪些条件"></textarea>
								</div>
                                <div>
									<span>参赛经历及自我介绍<i style="font-weight:400"></i></span>
                                    <textarea id="tb_pensonal_evaluate" runat="server" placeholder="参加过得比赛和获得的成果"></textarea>
								</div>
                                <div>
									<span>我的队友要求<i style="font-weight:400">（选填）</i></span>
                                    <textarea style="min-height:120px" id="tb_require" runat="server"></textarea>
								</div>
                                <asp:Button ID="Button1" class="contact-anniu" runat="server" Text="提 交" OnClick="Button1_Click" />
							</form>
						</div>
						<div class="clearfix"> </div>
					</div>
