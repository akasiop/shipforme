<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="second_contact" %>
				...
				<div class="container">
					<div class="contact-grids">
						<div class="contact-left">
							<h2>Address</h2>
							<span>云南财经大学（呈贡校区）高等街2502号</span>
							<p>2502 Gao Jie, Yunnan University of Finance</p> 联系方式</p><p> 组长：马友诚</p><p> Tell 0871-12345678</p>
							<p> Email 1209977477@qq.com</p>
						</div>
						<div class="contact-right">
							...
							<form>
								...
								<input type="submit" class="contact-anniu" Value="提交" />
							</form>
						</div>
						<div class="clearfix"> </div>
					</div>
