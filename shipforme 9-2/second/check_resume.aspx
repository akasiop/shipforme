<%@ Page Language="C#" AutoEventWireup="true" CodeFile="check_resume.aspx.cs" Inherits="second_2_check_resume" %>
					...
					<div class="contact-grids">
						...
						<div class="contact-right" >
							<form id="Form1" runat="server">
                                ...
                                <asp:Button ID="Button1" class="contact-anniu" runat="server" Text="返 回" OnClick="Button1_Click" />
						</form>
                                </div>
						<div class="clearfix"> </div>
					</div>
