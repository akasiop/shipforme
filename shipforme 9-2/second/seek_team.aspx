<%@ Page Language="C#" AutoEventWireup="true" CodeFile="seek_team.aspx.cs" Inherits="second_seek_team" %>
...
<asp:PostBackTrigger ControlID="GridView1" />
            ...
            <ContentTemplate>
                ...
                <br />
                <asp:GridView ID="GridView1" OnRowDataBound="gridView1_RowDataBound" runat="server" CssClass="GridViewStyle" OnRowCommand="OnRowCommand"  AutoGenerateColumns="False"  DataSourceID="SqlDataSource2" >
                    <Columns>
