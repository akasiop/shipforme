<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="second_register" %>
				...
				<div class="container">
					<div class="contact-grids">
						<div class="contact-left">
							<h2>register</h2>
                            <p><img src="../images/register.png" style="width:100%"/></p>
						...
						<div class="contact-right">
							...
							<form id="form1" runat="server">
								...
								<div>
									<span>学号</span>
									 <asp:TextBox ID="tbusername" runat="server" CssClass="contact-right_Text"></asp:TextBox>
								</div>
                                <div>
									<span>姓名</span>
									 <asp:TextBox ID="name" runat="server" CssClass="contact-right_Text"></asp:TextBox>
								</div>
								<div>
									<span>密码</span>
									 <asp:TextBox ID="tbpsw" runat="server" TextMode="Password" placeholder="6-12位密码，区分大小写"></asp:TextBox>
								</div>
                                <div>
									<span>确认密码</span>
									 <asp:TextBox ID="tbpsw2" runat="server" TextMode="Password"></asp:TextBox>
                                    
								
                                </div>
								<asp:Button ID="btnLogin" runat="server" CssClass="contact-anniu" Text="注册" onclick="btnLogin_Click" />
							</form>
						</div>
						<div class="clearfix"> </div>
					</div>
