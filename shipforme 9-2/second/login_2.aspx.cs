...
public partial class second_login_2 : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            conn.Open();
            string sql = "select * from [user_service] where username='" + username + "'";
            ...
            if (sdr.Read())
            {
                if (password == sdr["password"].ToString())
                {
                    ...
                    Response.Redirect("../second/personal_2.aspx");
                }
                else
                {
